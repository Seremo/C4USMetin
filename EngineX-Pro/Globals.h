...
ServerName Globals::Server = ServerName::VALIUM;
...
void Globals::ReAddressingInstances()
{
	switch (Globals::Server)
	{
		...
		case ServerName::ASENIS:
			{
				pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x37965d8; // [100 ] [103 / 103]
				pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x3796604; // [98 ] [76 / 77]
				pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x37965e8; // [95 ] [40 / 42]
				pCItemManagerInstance = Globals::hEntryBaseAddress + 0x3801820; // [100 ] [41 / 41]
				pCPythonItemInstance = Globals::hEntryBaseAddress + 0x3801844; // [100 ] [5 / 5]
				pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x379DCF8;
				pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x3801810; // [100 ] [7 / 7]
				pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x3801818; // [100 ] [103 / 103]
				pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x37965f8; // [100 ] [5 / 5]
				pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x36D5D8C;
				break;
			}
...
void Globals::ReAddressingLocas()
{
	switch (Globals::Server)
	{
		...
		case ServerName::ASENIS:
		{
				...
				pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0x899C0; 
		...
		case ServerName::CLASSIC:
			{
				...
				pCInstanceBaseAvoidObject = Globals::hEntryBaseAddress + 0x17d530; // [100 ] [1 / 1]
				...
				pCItemDataGetName = Globals::hEntryBaseAddress + 0x1735b0; // [100 ] [1 / 1]
				pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x182a70; // [100 ] [1 / 1]
				pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x72f80; // [100 ] [1 / 1]
				pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x12c850; // [100 ] [1 / 1]
				pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0xd5f90; // [100 ] [1 / 1]
				pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0xd5760; // [100 ] [1 / 1]
				pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x12c970; // [100 ] [1 / 1]
				pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x12c9e0; // [100 ] [1 / 1]
				pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x12cbe0; // [100 ] [1 / 1]
				pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x12cc20; // [100 ] [1 / 1]
				pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + 0x16c0a0; // [100 ] [1 / 1]
				pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x193490; // [100 ] [1 / 1]
				pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0xc2500; // [100 ] [1 / 1]
				pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0xc2c00; // [100 ] [1 / 1]
				...
				pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0xd5550; // [100 ] [1 / 1]
				pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0xd5870; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0xe11e0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0xe07e0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0xe0930; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0xe0a80; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0xd5b00; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0xe0f70; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0xe1090; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0xe1100; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0xe1180; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0xe1270; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0xe45e0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0xe4650; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0xe4780; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0xe47d0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0xe1ad0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0xe1e70; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0xe1f20; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0xe4b70; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0xe4be0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0xe4ca0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0xe1f60; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0xe2060; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0xe20c0; // [100 ] [1 / 1]
				pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0xd64e0; // [100 ] [1 / 1]
				...
				pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x130300; // [100 ] [1 / 1]
				pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x122e20; // [100 ] [1 / 1]
				pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x13ed10; // [100 ] [1 / 1]
				pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x1d05e0; // [100 ] [1 / 1]
				pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0xc53e0; // [100 ] [1 / 1]
				pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x12d2c0; // [100 ] [1 / 1]
