...
ServerName Globals::Server = ServerName::CALLIOPE;
...
void Globals::ReAddressingLocas()
{
	switch (Globals::Server)
	{
		...
		{
			pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x1c32150; // [100 ] [5 / 5]
			pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x1c2f3f0;
			pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x1c2f3e0; // [100 ] [1 / 1]
			pCItemManagerInstance = Globals::hEntryBaseAddress + 0x1C2F3FC;
			pCPythonItemInstance = Globals::hEntryBaseAddress + 0x1C321D4;
			pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x1C34B24;
			pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x1c2f3e4; // [100 ] [13 / 13]
			pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x1C2F3EC;
			pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x1c32194; // [100 ] [6 / 6]
			pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x40D480;
			pCPythonBackgroundGlobalPositionToMapInfo = Globals::hEntryBaseAddress + 0x1DBB0;
			pCInstanceBaseAvoidObject = Globals::hEntryBaseAddress + 0x40d040; // [100 ] [1 / 1]
			pCInstanceBaseBlockMovement = Globals::hEntryBaseAddress + 0xD715;
			pCInstanceBaseGetInstanceType = Globals::hEntryBaseAddress + 0xd55d; // [100 ] [1 / 1]
			pCInstanceBaseGetInstanceVirtualNumber = Globals::hEntryBaseAddress + 0x15b86; // [100 ] [1 / 1]
			pCInstanceBaseGetNameString = Globals::hEntryBaseAddress + 0x19ec0; // [100 ] [1 / 1]
			pCInstanceBaseGetRotation = Globals::hEntryBaseAddress + 0x1a2bc; // [100 ] [1 / 1]
			pCInstanceBaseIsDead = Globals::hEntryBaseAddress + 0x16dd80; // [100 ] [2 / 2]
			pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0x16d930; // [100 ] [2 / 2]
			pCInstanceBaseNEW_GetPixelPosition = Globals::hEntryBaseAddress + 0x1d386; // [100 ] [1 / 1]
			pCInstanceBaseNEW_MoveToDestPixelPositionDirection = Globals::hEntryBaseAddress + 0x2122e; // [100 ] [1 / 1]
			pCInstanceBaseSCRIPT_SetPixelPosition = Globals::hEntryBaseAddress + 0x1cb70; // [100 ] [1 / 1]
			pCInstanceBaseSetDirection = Globals::hEntryBaseAddress + 0xc991; // [100 ] [1 / 1]
			pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x182370; // [100 ] [1 / 1]
			pCItemDataGetName = Globals::hEntryBaseAddress + 0x3ffdc0; // [100 ] [1 / 1]
			pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x414210; // [100 ] [1 / 1]
			pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x193600; // [100 ] [1 / 1]
			pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x3a2690; // [100 ] [1 / 1]
			pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x30cd70; // [100 ] [2 / 2]
			pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x30c000; // [100 ] [2 / 2]
			pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x3a2920; // [100 ] [1 / 1]
			pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0xa420; // [50 ] [1 / 2]
			pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x3a2990; // [50 ] [1 / 2]
			pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x3a2bf0; // [100 ] [1 / 1]
			pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x3a2c70; // [100 ] [1 / 1]
			//pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + (null); 
			pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0xb785; // [50 ] [1 / 2]
			pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x2bbbf0; // [100 ] [2 / 2]
			pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x2BB990;
			pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x1729c;
			pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x239270;
			pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x4f52; // [100 ] [1 / 1]
			pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x30c190; // [100 ] [1 / 1]
			pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x30c420; // [100 ] [2 / 2]
			pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x31d6f0; // [100 ] [2 / 2]
			pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x31ce60; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x31cec0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0xe5fc; // [100 ] [1 / 1]
			//pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + (null); 
			pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x31d330; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x31d210; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x31d180; // [100 ] [2 / 2]
			//pCPythonNetworkStreamSendFishingQuitPacket = Globals::hEntryBaseAddress + (null); 
			pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x31e530; // [100 ] [1 / 1]
			...
			pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x3367c0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x3369c0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x336400; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x31d610; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendRefinePacket = Globals::hEntryBaseAddress + 0x31E9A0; // [100 ] [2 / 2]
			pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x31d410; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x31d770; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0x336c10; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0x336bb0; // [100 ] [1 / 1]
			//pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + (null); 
			pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x31c930; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x31d020; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x31ffc0; // [100 ] [2 / 2]
			pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x30f960; // [100 ] [10 / 10]
			pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0x6dc5; // [100 ] [3 / 3]
			pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x209160;
			pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0x1979a;
			pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0x1e3e30; // [100 ] [1 / 1]
			pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0x1e3080; // [100 ] [1 / 1]
			pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0x19EC0;
			pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0x416b00; // [100 ] [1 / 1]
			pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0x1e3610; // [100 ] [1 / 1]
			pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x1f7e80; // [100 ] [2 / 2]
			pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0x1e5060; // [100 ] [2 / 2]
			pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0x1e5090; // [100 ] [2 / 2]
			//pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + (null); 
			pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0x1F80C;
			pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x245E1;
			pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x1f7b50; // [100 ] [1 / 1]
			pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x1f8160; // [100 ] [1 / 1]
			pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x1f7f60; // [100 ] [1 / 1]
			pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x3a6f20; // [7 ] [1 / 14]
			pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x43d6; // [100 ] [18 / 18]
			pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x3bbb70; // [50 ] [1 / 2]
			pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x1D59D;
			pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x1207B;
			pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x1C3805C;
			pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x3a3450; // [100 ] [1 / 1]
			pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x18E2E0;
			pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x21DF0;
			pCInstanceBase__GetBackgroundHeight = Globals::hEntryBaseAddress + 0x11A90; // [100 %] [1 / 1]
			break;
		}
		case ServerName::CALLIOPE:
		{
			...
			pCInstanceBaseSetDirection = Globals::hEntryBaseAddress + 0x76220; // [100 ] [2 / 2]
