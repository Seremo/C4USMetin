...
{
#ifdef  ATYVA
	pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x2566a18; // [100 ] [103 / 103]
	pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x2562844; // [100 ] [91 / 91]
	pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x2562830; // [100 ] [42 / 42]
	pCItemManagerInstance = Globals::hEntryBaseAddress + 0x256284c; // [100 ] [50 / 50]
	pCPythonItemInstance = Globals::hEntryBaseAddress + 0x2566a88; // [100 ] [7 / 7]
	pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x2568BB8; // [100 ] [59 / 59]
	pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x2562834; // [100 ] [7 / 7]
	pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x2562840; // [100 ] [130 / 130]
	pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x2566a4c; // [100 ] [4 / 4]
	pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x256B314;

	pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x1e39940; // [100 ] [1 / 1]
	pCPythonBackgroundGetWarpMapName = Globals::hEntryBaseAddress + 0x1cda6a0; // [100 ] [1 / 1]
	pCPythonBackgroundGlobalPositionToMapInfo = Globals::hEntryBaseAddress + 0x1cda610; // [100 ] [1 / 1]
	pCInstanceBaseAvoidObject = Globals::hEntryBaseAddress + 0x1cbc850; // [100 ] [1 / 1]
	pCInstanceBaseBlockMovement = Globals::hEntryBaseAddress + 0x1cbc890; // [100 ] [1 / 1]
	pCInstanceBaseGetInstanceType = Globals::hEntryBaseAddress + 0x1cbb690; // [100 ] [1 / 1]
	pCInstanceBaseGetInstanceVirtualNumber = Globals::hEntryBaseAddress + 0x1cbb740; // [100 ] [1 / 1]
	pCInstanceBaseGetNameString = Globals::hEntryBaseAddress + 0x1cbb650; // [100 ] [1 / 1]
	pCInstanceBaseGetRotation = Globals::hEntryBaseAddress + 0x1cd4cb0; // [100 ] [1 / 1]
	pCInstanceBaseIsDead = Globals::hEntryBaseAddress + 0x1cbc610; // [100 ] [1 / 1]
	pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0x1cbc260; // [100 ] [1 / 1]
	pCInstanceBaseNEW_GetPixelPosition = Globals::hEntryBaseAddress + 0x1cd4bf0; // [100 ] [1 / 1]
	pCInstanceBaseNEW_MoveToDestPixelPositionDirection = Globals::hEntryBaseAddress + 0x1cd44c0; // [100 ] [1 / 1]
	pCInstanceBaseNEW_SetPixelPosition = Globals::hEntryBaseAddress + 0x1cd4b50; // [100 ] [1 / 1]
	pCInstanceBaseSCRIPT_SetPixelPosition = Globals::hEntryBaseAddress + 0x1cd4b70; // [100 ] [1 / 1]
	pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x1ccb800; // [100 ] [1 / 1]
	pCItemDataGetName = Globals::hEntryBaseAddress + 0x1e2f500; // [100 ] [1 / 1]
	pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x1e3ead0; // [100 ] [1 / 1]
	pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x1cd8cb0; // [100 ] [1 / 1]
	pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x1decd20; // [100 ] [1 / 1]
	pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x1d89ef0; // [100 ] [1 / 1]
	pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x1d892f0; // [100 ] [1 / 1]
	pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x1decef0; // [100 ] [1 / 1]
	pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x1decf60; // [100 ] [1 / 1]
	pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x1ded160; // [100 ] [1 / 1]
	pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x1ded1a0; // [100 ] [1 / 1]
	//pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + (null); 
	pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x1e4fea0; // [100 ] [1 / 1]
	pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x1d6a8d0; // [100 ] [1 / 1]
	pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x1d6a1d0; // [100 ] [1 / 1]
	pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x1ce4600; // [100 ] [1 / 1]
	pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x1d33720; // [100 ] [1 / 1]
	pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x1cf0ce0; // [100 ] [1 / 1]
	pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x1d89470; // [100 ] [1 / 1]
	pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x1d89690; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x1d94290; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x1d93980; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x1d939e0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0x1d95be0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0x1d88e70; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x1d93ef0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x1d93d90; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x1d93d10; // [100 ] [1 / 1]
	//pCPythonNetworkStreamSendFishingQuitPacket = Globals::hEntryBaseAddress + (null); 
	pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x1d950b0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0x1d95110; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0x1da3cb0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x1da3da0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x1da3f50; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x1da3a70; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x1d941b0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendRefinePacket = Globals::hEntryBaseAddress + 0x1d95300; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x1d93fb0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x1d94310; // [100 ] [1 / 1]
	...
	pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0x1da4270; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x1d936d0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x1d93b40; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x1d95d00; // [100 ] [1 / 1]
	pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x1d8b7c0; // [100 ] [1 / 1]
	pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0x1d028f0; // [100 ] [1 / 1]
	pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x1d182e0; // [100 ] [1 / 1]
	pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0x1d079c0; // [100 ] [1 / 1]
	pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0x1d07c80; // [100 ] [1 / 1]
	pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0x1d070d0; // [100 ] [1 / 1]
	pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0x1d07300; // [100 ] [1 / 1]
	pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0x1d07360; // [100 ] [1 / 1]
	pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0x1d07560; // [100 ] [1 / 1]
	pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x1d0ea10; // [100 ] [1 / 1]
	pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0x1d089f0; // [100 ] [1 / 1]
	pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0x1d08a20; // [100 ] [1 / 1]
	pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + 0x1d0e410; // [100 ] [1 / 1]
	pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0x1d069d0; // [100 ] [1 / 1]
	pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x1d0fa20; // [100 ] [1 / 1]
	pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x1d0e780; // [100 ] [1 / 1]
	pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x1d0ecf0; // [100 ] [1 / 1]
	pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x1d0eb00; // [100 ] [1 / 1]
	pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x1df0940; // [100 ] [1 / 1]
	pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x1de2e70; // [100 ] [1 / 1]
	pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x1dfedb0; // [100 ] [1 / 1]
	pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x1e8cb60; // [100 ] [1 / 1]
	pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x1d6ef40; // [100 ] [1 / 1]
	pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x1ded8b0; // [100 ] [1 / 1]

	pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x1cd4010; // [100 %] [1 / 1]
	pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x1cd4cf0; // [100 %] [1 / 1]
#endif
#ifdef  VIDGAR
...
#ifdef VISERION
	pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x19fadfc; // [100 ] [105 / 105]
	pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x19f8b80; // [100 ] [90 / 90]
	pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x19f8b6c; // [100 ] [47 / 47]
	pCItemManagerInstance = Globals::hEntryBaseAddress + 0x19f8b88; // [100 ] [53 / 53]
	pCPythonItemInstance = Globals::hEntryBaseAddress + 0x19faf64; // [100 ] [7 / 7]
	pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x19FD1E0; // [100 ] [58 / 58]
	pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x19f8b70; // [100 ] [8 / 8]
	pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x19f8b7c; // [100 ] [130 / 130]
	pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x19faf00; // [100 ] [5 / 5]
	pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x15be341; // [100 ] [1 / 1]
	...
	pCInstanceBaseAvoidObject = Globals::hEntryBaseAddress + 0x247960; // [100 ] [2 / 2]
	pCInstanceBaseBlockMovement = Globals::hEntryBaseAddress + 0x7f630; // [100 ] [1 / 1]
	...
	pCInstanceBaseIsDead = Globals::hEntryBaseAddress + 0x7f3b0; // [100 ] [2 / 2]
	...
	pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x8a900; // [100 ] [1 / 1]
	pCItemDataGetName = Globals::hEntryBaseAddress + 0x23d820; // [100 ] [2 / 2]

	pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x24cf80; // [80 ] [4 / 5]
	pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0xb02e0; // [100 ] [1 / 1]
	pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x1eab50; // [100 ] [1 / 1]
	pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x18d890; // [100 ] [2 / 2]
	pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x18cc50; // [100 ] [2 / 2]
	pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x1ead50; // [100 ] [2 / 2]
	pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x1eadc0; // [100 ] [2 / 2]
	pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x1eafd0; // [100 ] [2 / 2]
	pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x1eb010; // [100 ] [2 / 2]
	pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + 0x1EB090; 
	pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x25e330; // [100 ] [2 / 2]
	pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x16d120; // [100 ] [1 / 1]
	pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x16c9f0; // [100 ] [1 / 1]
	pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0xb9d00; // [100 ] [30 / 30]
	pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x12b1e0; // [100 ] [1 / 1]
	pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0xd2150; // [100 ] [1 / 1]
	pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x18cdd0; // [100 ] [2 / 2]
	pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x18d000; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x199030; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x198730; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x198790; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0x19ac20; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0x18c7c0; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x198d10; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x198b40; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x198ac0; // [100 ] [3 / 3]
	
	pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x199e40; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0x199ea0; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0x1a9fc0; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x1aa0b0; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x1aa260; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x1a9d60; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x198fd0; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendRefinePacket = Globals::hEntryBaseAddress + 0x19a550; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x198dd0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x199130; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0x1aa4d0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0x1aa470; // [100 ] [2 / 2]
	//pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + (null); 
	pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x198480; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x1988f0; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x19ad40; // [100 ] [1 / 1]
	pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x1902a0; // [100 ] [10 / 10]
	pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0xece60; // [100 ] [4 / 4]
	pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x112530; // [100 ] [2 / 2]
	pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0x100cf0; // [100 ] [8 / 8]
	pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0x100fa0; // [100 ] [3 / 3]
	pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0x100280; // [100 ] [2 / 2]
	pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0x100570; // [100 ] [3 / 3]
	pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0x1005d0; // [100 ] [2 / 2]
	pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0x1007e0; // [100 ] [5 / 5]
	pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x108a20; // [100 ] [1 / 1]
	pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0x101f50; // [100 ] [1 / 1]
	pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0x101f80; // [100 ] [2 / 2]
	pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + 0x108420; // [100 ] [1 / 1]
	pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0xffbb0; // [100 ] [14 / 14]
	pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x109a80; // [100 ] [2 / 2]
	pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x108790; // [100 ] [3 / 3]
	pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x108d00; // [100 ] [1 / 1]
	pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x108b10; // [100 ] [1 / 1]
	pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x1fc9f0; // [100 ] [14 / 14]
	pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x1ee760; // [100 ] [21 / 21]
	pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x20ae50; // [100 ] [3 / 3]
	pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x29AEF0; 
	pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x1719a0; // [100 ] [2 / 2]
	pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x19FFEE4; 
	pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x1f9c10; // [100 ] [1 / 1]
	pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x932a0; // [100 ] [1 / 1]
...
#ifdef PYTHON_CUSTOM
#ifdef ATYVA
	Globals::PyRun_SimpleStringFlags = (tPyRun_SimpleStringFlags)(Globals::hEntryBaseAddress + 0x1ef0f20);
	Globals::PyString_AsString = (tPyString_AsString)(Globals::hEntryBaseAddress + 0x1ebc630);
	Globals::PyTuple_GetItem = (tPyTuple_GetItem)(Globals::hEntryBaseAddress + 0x1ed9380);
	Globals::PyInt_AsLong = (tPyInt_AsLong)(Globals::hEntryBaseAddress + 0x1ee0c90);
#else
