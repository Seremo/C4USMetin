...
//pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + (null); 
//pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + (null); 
//pCPythonBackgroundInstance = Globals::hEntryBaseAddress + (null); 
//pCItemManagerInstance = Globals::hEntryBaseAddress + (null); 
//pCPythonItemInstance = Globals::hEntryBaseAddress + (null); 
//pCPythonApplicationInstance = Globals::hEntryBaseAddress + (null); 
//pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + (null); 
//pCPythonPlayerInstance = Globals::hEntryBaseAddress + (null); 
//pCResourceManagerInstance = Globals::hEntryBaseAddress + (null); 
