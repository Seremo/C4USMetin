...
ServerName Globals::Server = ServerName::NEVILLA;
...
void Globals::ReAddressingLocas()
{
	switch (Globals::Server)
	{
		...
		case ServerName::DEVERIA:
			{
				pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x197EA0;
				pCPythonBackgroundGlobalPositionToMapInfo = Globals::hEntryBaseAddress + 0x78b10; // [100 ] [3 / 3]
				...
				pCInstanceBaseGetNameString = Globals::hEntryBaseAddress + 0x61690; // [83 ] [5 / 6]
				pCInstanceBaseGetNameString = Globals::hEntryBaseAddress + 0xffc0000d; // [16 ] [1 / 6]
				pCInstanceBaseGetRotation = Globals::hEntryBaseAddress + 0x6b1c0; // [100 ] [6 / 6]
				pCInstanceBaseIsDead = Globals::hEntryBaseAddress + 0x5ff20; // [100 ] [6 / 6]
				pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0x5fbe0; // [77 ] [7 / 9]
				pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0x635c0; // [11 ] [1 / 9]
				pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0xffc0000d; // [11 ] [1 / 9]
				pCInstanceBaseNEW_GetPixelPosition = Globals::hEntryBaseAddress + 0x6b0e0; // [100 ] [13 / 13]
				...
				pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x67c10; // [100 ] [2 / 2]
				pCItemDataGetName = Globals::hEntryBaseAddress + 0x19bb50; // [83 ] [5 / 6]
				pCItemDataGetName = Globals::hEntryBaseAddress + 0x1d8ba0; // [16 ] [1 / 6]
				pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x199c10; // [100 ] [8 / 8]
				pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x6b0e0; // [50 ] [1 / 2]
				pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x78a20; // [50 ] [1 / 2]
				pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x14a170; // [100 ] [5 / 5]
				pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0xa08f0; // [100 ] [1 / 1]
				pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0xA00E0; 
				pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x14a360; // [100 ] [3 / 3]
				pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x14a3a0; // [100 ] [5 / 5]
				pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x14a5b0; // [100 ] [1 / 1
				pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x14a5f0; // [100 ] [1 / 1]
				pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + 0x14a640; // [100 ] [1 / 1]
				pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x1adcb0; // [100 ] [1 / 1]
				pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x71500; // [100 ] [2 / 2]
				pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x70b40; // [100 ] [19 / 19]
				pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x7c0a0; // [86 ] [20 / 23]
				pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x82cc0; // [100 ] [2 / 2]
				pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x882e0; // [100 ] [3 / 3]
				pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0xa01c0; // [100 ] [2 / 2]
				pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0xa0840; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0xa9d50; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0xa98c0; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0xa7160; // [100 ] [3 / 3]
				pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0xa7350; // [100 ] [7 / 7]
				pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0xa09e0; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0xa8fb0; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0xa8f30; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0xa8dc0; // [100 ] [3 / 3]
				pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x5a3c0; // [25 ] [1 / 4]
				pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0xabcd0; // [75 ] [3 / 4]
				pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0xabd30; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0xafa70; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0xafc30; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0xafd60; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0xaf8b0; // [100 ] [4 / 4]
				pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0xa8070; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0xa91f0; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0xa9c70; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0xaf6e0; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0xaf680; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0xaf800; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0xa9930; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0xa72e0; // [100 ] [3 / 3]
				pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0xa7b70; // [50 ] [1 / 2]
				pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x194000; // [50 ] [1 / 2]
				pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0xa13d0; // [100 ] [15 / 15]
				pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0x61ce0; // [20 ] [2 / 10]
				pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0xb2c70; // [80 ] [8 / 10]
				pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0xcdab0; // [100 ] [4 / 4]
				pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0xB4550; 
				pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0xb4880; // [100 ] [2 / 2]
				pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0xb3c30; // [100 ] [2 / 2]
				pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0xb40d0; // [100 ] [3 / 3]
				pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0x8d730; // [100 ] [1 / 1]
				pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0xb40a0; // [100 ] [3 / 3]
				pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0xb8020; // [100 ] [2 / 2]
				pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0xb54a0; // [100 ] [2 / 2]
				pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0xb5480; // [100 ] [2 / 2]
				pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + 0xb8830; // [100 ] [1 / 1]
				pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0xb3920; // [100 ] [12 / 12]
				pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0xb9070; // [100 ] [2 / 2]
				pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0xb8050; // [100 ] [3 / 3]
				...
				pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x7b870; // [100 ] [19 / 19]
				pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x1506d0; // [100 ] [42 / 42]
				pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x16e910; // [100 ] [2 / 2]
				pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x1D87E0; 
				pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x74000; 
				pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x156300; // [100 ] [1 / 1]
				pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x6aca0; // [100 ] [4 / 4]
				pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x6b110; // [100 ] [3 / 3]
		...
		case ServerName::NEVILLA:
			{
				pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x121070; // [100 ] [1 / 1]
				pCPythonBackgroundGlobalPositionToMapInfo = Globals::hEntryBaseAddress + 0x5be80; // [100 ] [1 / 1]
				pCInstanceBaseAvoidObject = Globals::hEntryBaseAddress + 0x120c50; // [100 ] [1 / 1]
				pCInstanceBaseBlockMovement = Globals::hEntryBaseAddress + 0x41430; // [100 ] [1 / 1]
				pCInstanceBaseGetInstanceType = Globals::hEntryBaseAddress + 0x44820; // [100 ] [1 / 1]
				pCInstanceBaseGetInstanceVirtualNumber = Globals::hEntryBaseAddress + 0x44840; // [100 ] [1 / 1]
				pCInstanceBaseGetNameString = Globals::hEntryBaseAddress + 0x44220; // [83 ] [5 / 6]
				pCInstanceBaseGetRotation = Globals::hEntryBaseAddress + 0x4d840; // [100 ] [1 / 1]
				pCInstanceBaseIsDead = Globals::hEntryBaseAddress + 0x42a00; // [100 ] [1 / 1]
				pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0x426d0; // [71 ] [5 / 7]
				pCInstanceBaseNEW_GetPixelPosition = Globals::hEntryBaseAddress + 0x4d760; // [100 ] [1 / 1]
				pCInstanceBaseNEW_MoveToDestPixelPositionDirection = Globals::hEntryBaseAddress + 0x4d3e0; // [100 ] [1 / 1]
				pCInstanceBaseSCRIPT_SetPixelPosition = Globals::hEntryBaseAddress + 0x4d700; // [100 ] [1 / 1]
				pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x4a640; // [100 ] [1 / 1]
				pCItemDataGetName = Globals::hEntryBaseAddress + 0x12c2b0; // [100 ] [1 / 1]
				pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x12e010; // [100 ] [1 / 1]
				pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x5bdb0; // [100 ] [1 / 1]
				pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0xd9e60; // [100 ] [1 / 1]
				pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x81b30; // [100 ] [1 / 1]
				pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x81330; // [100 ] [1 / 1]
				pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0xda080; // [100 ] [1 / 1]
				pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0xda0c0; // [100 ] [1 / 1]
				pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0xda2d0; // [100 ] [1 / 1]
				pCNetworkStreamSend = Globals::hEntryBaseAddress + 0xda310; // [100 ] [1 / 1]
				pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + 0xda360; // [100 ] [1 / 1]
				pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x13e9a0; // [100 ] [1 / 1]
				pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x54880; // [100 ] [1 / 1]
				pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x53f00; // [100 ] [1 / 1]
				pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x5eea0; // [100 ] [1 / 1]
				pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x658f0; // [100 ] [1 / 1]
				pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x6ab90; // [100 ] [1 / 1]
				pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x81420; // [100 ] [1 / 1]
				pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x81a70; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x8baf0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x8b690; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x88d20; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0x88ef0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0x81c20; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x8ac30; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x8abb0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x8aab0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x8de40; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0x8dea0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0x91810; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x919d0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x91bd0; // [100 ] [3 / 3]
				pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x91650; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x89cb0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x8ae80; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x8ba10; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0x91480; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0x91420; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0x915a0; // [100 ] [2 / 2]
				pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x8b6f0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x88e80; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x14fde0; // [100 ] [1 / 1]
				pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x82820; // [100 ] [1 / 1]
				pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0x94a70; // [100 ] [1 / 1]
				pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x9fda0; // [100 ] [1 / 1]
				pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0x964C0; 
				pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0x12c3a0; // [100 ] [1 / 1]
				pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0x95b20; // [100 ] [1 / 1]
				pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0x44220; // [100 ] [2 / 2]
				pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0x6fbb0; // [100 ] [1 / 1]
				pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0x96000; // [100 ] [1 / 1]
				pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x99900; // [100 ] [1 / 1]
				pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0x973b0; // [100 ] [1 / 1]
				pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0x97390; // [100 ] [1 / 1]
				pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + 0x9a0d0; // [100 ] [1 / 1]
				pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0x95820; // [100 ] [1 / 1]
				pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x9a910; // [100 ] [1 / 1] 
				pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x99940; // [100 ] [1 / 1]
				pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x99df0; // [100 ] [1 / 1]
				pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x99c60; // [100 ] [1 / 1]
				pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x5e310; // [100 ] [1 / 1]
				pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0xdf2a0; // [100 ] [1 / 1]
				pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0xe0ae0; // [100 ] [1 / 1](null); 
				pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0xe0ae0; // [100 ] [1 / 1]
				pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x1694d0; // [100 ] [1 / 1]
				pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x57380; // [100 ] [1 / 1]
				pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0xe79b0; // [100 ] [1 / 1]
				pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x4d320; // [100 ] [1 / 1]
				pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x4d790; // [100 ] [1 / 1]
				pCInstanceBase__GetBackgroundHeight = Globals::hEntryBaseAddress + 0x41720; // [100 ] [1 / 1]
				break;
			}
	}
}
