...
{
#ifdef  ATYVA
	pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x29328b8; // [100 ] [104 / 104]
	pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x292e6e4; // [100 ] [91 / 91]
	pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x292e6d0; // [100 ] [42 / 42]
	pCItemManagerInstance = Globals::hEntryBaseAddress + 0x292e6ec; // [100 ] [49 / 49]
	pCPythonItemInstance = Globals::hEntryBaseAddress + 0x2932928; // [100 ] [7 / 7]
	pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x2934A58; // [100 ] [75 / 75]
	pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x292e6d4; // [100 ] [7 / 7]
	pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x292e6e0; // [100 ] [129 / 129]
	pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x29328ec; // [100 ] [4 / 4]
	pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x2add80; // [100 ] [3 / 3]
	pCPythonBackgroundGetWarpMapName = Globals::hEntryBaseAddress + 0x14d4f0; // [100 ] [4 / 4]
	pCPythonBackgroundGlobalPositionToMapInfo = Globals::hEntryBaseAddress + 0x14d460; // [100 ] [3 / 3]
	pCInstanceBaseAvoidObject = Globals::hEntryBaseAddress + 0x12f570; // [100 ] [1 / 1]
	pCInstanceBaseBlockMovement = Globals::hEntryBaseAddress + 0x12f5b0; // [100 ] [4 / 4]
	pCInstanceBaseGetInstanceType = Globals::hEntryBaseAddress + 0x12e390; // [100 ] [1 / 1]
	pCInstanceBaseGetInstanceVirtualNumber = Globals::hEntryBaseAddress + 0x12E460; 
	pCInstanceBaseGetNameString = Globals::hEntryBaseAddress + 0x12e350; // [100 ] [12 / 12]
	pCInstanceBaseGetRotation = Globals::hEntryBaseAddress + 0x147b00; // [100 ] [8 / 8]
	pCInstanceBaseIsDead = Globals::hEntryBaseAddress + 0x12f330; // [100 ] [8 / 8]
	pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0x12ef80; // [100 ] [13 / 13]
	pCInstanceBaseNEW_GetPixelPosition = Globals::hEntryBaseAddress + 0x147a40; // [100 ] [29 / 29]
	pCInstanceBaseNEW_MoveToDestPixelPositionDirection = Globals::hEntryBaseAddress + 0x147310; // [100 ] [9 / 9]
	pCInstanceBaseNEW_SetPixelPosition = Globals::hEntryBaseAddress + 0x1479a0; // [100 ] [4 / 4]
	pCInstanceBaseSCRIPT_SetPixelPosition = Globals::hEntryBaseAddress + 0x1479c0; // [100 ] [3 / 3]
	pCInstanceBaseSetDirection = Globals::hEntryBaseAddress + 0x147bb0; // [100 ] [2 / 2]
	pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x13e650; // [100 ] [4 / 4]
	pCItemDataGetName = Globals::hEntryBaseAddress + 0x2a3940; // [100 ] [5 / 5]
	pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x2b2f10; // [90 ] [9 / 10]

	pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x14bb00; // [100 ] [3 / 3]
	pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x261a10; // [100 ] [5 / 5]
	pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x1FDAA0; 
	pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x1FCEB0; 
	pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x261be0; // [100 ] [2 / 2]
	pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x261c50; // [100 ] [6 / 6]
	

	pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x261e60; // [100 ] [2 / 2]
	pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x261ea0; // [100 ] [2 / 2]

	pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + 0x261f20; // [100 ] [86 / 86]
	pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x2c42f0; // [100 ] [2 / 2]
	pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x1dde20; // [100 ] [2 / 2]
	pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x1dd720; // [100 ] [19 / 19]
	pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x157450; // [50 ] [30 / 59]

	pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x1a6aa0; // [50 ] [1 / 2]

	pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x163b50; // [100 ] [3 / 3]
	pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x1fd030; // [100 ] [2 / 2]
	pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x1fd220; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x207e70; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x207560; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x2075c0; // [100 ] [10 / 10]
	pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0x209820; // [100 ] [7 / 7]
	pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0x1fca30; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x207ad0; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x207970; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x2078f0; // [100 ] [3 / 3]
	
	pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x208c90; // [100 ] [4 / 4]
	pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0x208cf0; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0x218720; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x218810; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x2189c0; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x2184e0; // [100 ] [4 / 4]
	pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x207d90; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendRefinePacket = Globals::hEntryBaseAddress + 0x208ee0; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x207b90; // [100 ] [3 / 3]
	pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x207ef0; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0x218bb0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0x218b50; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0x218ce0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x2072b0; // [100 ] [2 / 2]
	pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x207720; // [100 ] [5 / 5]
	pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x209940; // [100 ] [2 / 2]
	pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x1ff3e0; // [100 ] [16 / 16]
	pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0x1757c0; // [100 ] [9 / 9]
	pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x18b220; // [100 ] [4 / 4]
	pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0x17a890; // [77 ] [7 / 9]
	pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0x17ab50; // [100 ] [3 / 3]
	pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0x179fa0; // [100 ] [1 / 1]
	pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0x17a1d0; // [66 ] [4 / 6]
	pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0x17a230; // [100 ] [4 / 4]
	pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0x17a430; // [83 ] [5 / 6]
	pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x1818e0; // [100 ] [2 / 2]
	pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0x17b8c0; // [100 ] [3 / 3]
	pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0x17b8f0; // [100 ] [2 / 2]
	pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + 0x1812e0; // [100 ] [3 / 3]
	pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0x1798a0; // [82 ] [14 / 17]
	pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x1828f0; // [100 ] [2 / 2]
	pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x181650; // [75 ] [3 / 4]
	pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x181bc0; // [100 ] [2 / 2]
	pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x1819d0; // [100 ] [2 / 2]
	pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x265250; // [100 ] [4 / 4]
	pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x257af0; // [100 ] [8 / 8]
	pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x2736c0; // [100 ] [1 / 1]
	pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x300FE0; 
	pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x1e2490; // [100 ] [1 / 1]
	pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x29371AC; 
	pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x262470; // [100 ] [1 / 1]

	pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x146e60; // [100 ] [6 / 6]
	pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x147b40; // [100 ] [4 / 4]
#endif
#ifdef  VIDGAR
