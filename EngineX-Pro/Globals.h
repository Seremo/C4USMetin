...
{
#ifdef  ATYVA
	pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x25750d8; // [100 ] [103 / 103]
	pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x2570f04; // [100 ] [91 / 91]
	pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x2570ef0; // [100 ] [42 / 42]
	pCItemManagerInstance = Globals::hEntryBaseAddress + 0x2570f0c; // [100 ] [50 / 50]
	pCPythonItemInstance = Globals::hEntryBaseAddress + 0x2575148; // [100 ] [7 / 7]
	pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x2577278; // [100 ] [59 / 59]
	pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x2570ef4; // [100 ] [7 / 7]
	pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x2570f00; // [100 ] [130 / 130]
	pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x257510c; // [100 ] [4 / 4]
	pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x25799D4;

	pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x1e485b0; // [100 ] [1 / 1]
	pCPythonBackgroundGetWarpMapName = Globals::hEntryBaseAddress + 0x1ce92f0; // [100 ] [1 / 1]
	pCPythonBackgroundGlobalPositionToMapInfo = Globals::hEntryBaseAddress + 0x1ce9260; // [100 ] [1 / 1]
	pCInstanceBaseAvoidObject = Globals::hEntryBaseAddress + 0x1ccb4a0; // [100 ] [1 / 1]
	pCInstanceBaseBlockMovement = Globals::hEntryBaseAddress + 0x1ccb4e0; // [100 ] [1 / 1]
	pCInstanceBaseGetInstanceType = Globals::hEntryBaseAddress + 0x1cca2e0; // [100 ] [1 / 1]
	pCInstanceBaseGetInstanceVirtualNumber = Globals::hEntryBaseAddress + 0x1cca390; // [100 ] [1 / 1]
	pCInstanceBaseGetNameString = Globals::hEntryBaseAddress + 0x1cca2a0; // [100 ] [1 / 1]
	pCInstanceBaseGetRotation = Globals::hEntryBaseAddress + 0x1ce3900; // [100 ] [1 / 1]
	pCInstanceBaseIsDead = Globals::hEntryBaseAddress + 0x1ccb260; // [100 ] [1 / 1]
	pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0x1ccaeb0; // [100 ] [1 / 1]
	pCInstanceBaseNEW_GetPixelPosition = Globals::hEntryBaseAddress + 0x1ce3840; // [100 ] [1 / 1]
	pCInstanceBaseNEW_MoveToDestPixelPositionDirection = Globals::hEntryBaseAddress + 0x1ce3110; // [100 ] [1 / 1]
	pCInstanceBaseNEW_SetPixelPosition = Globals::hEntryBaseAddress + 0x1ce37a0; // [100 ] [1 / 1]
	pCInstanceBaseSCRIPT_SetPixelPosition = Globals::hEntryBaseAddress + 0x1ce37c0; // [100 ] [1 / 1]
	pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x1cda450; // [100 ] [1 / 1]
	pCItemDataGetName = Globals::hEntryBaseAddress + 0x1e3e170; // [100 ] [1 / 1]
	pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x1e4d750; // [100 ] [1 / 1]
	pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x1ce7900; // [100 ] [1 / 1]
	pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x1dfb990; // [100 ] [1 / 1]
	pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x1d98b50; // [100 ] [1 / 1]
	pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x1d97f50; // [100 ] [1 / 1]
	pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x1dfbb60; // [100 ] [1 / 1]
	pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x1dfbbd0; // [100 ] [1 / 1]
	pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x1dfbdd0; // [100 ] [1 / 1]
	pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x1dfbe10; // [100 ] [1 / 1]
	//pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + (null); 
	pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x1e5eb20; // [100 ] [1 / 1]
	pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x1d79520; // [100 ] [1 / 1]
	pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x1d78e20; // [100 ] [1 / 1]
	pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x1cf3250; // [100 ] [1 / 1]
	pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x1d42360; // [100 ] [1 / 1]
	pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x1cff920; // [100 ] [1 / 1]
	pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x1d980d0; // [100 ] [1 / 1]
	pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x1d982f0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x1da2f10; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x1da2600; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x1da2660; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0x1da4860; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0x1d97ad0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x1da2b70; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x1da2a10; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x1da2990; // [100 ] [1 / 1]
	//pCPythonNetworkStreamSendFishingQuitPacket = Globals::hEntryBaseAddress + (null); 
	pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x1da3d30; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0x1da3d90; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0x1db2930; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x1db2a20; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x1db2bd0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x1db26f0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x1da2e30; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendRefinePacket = Globals::hEntryBaseAddress + 0x1da3f80; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x1da2c30; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x1da2f90; // [100 ] [1 / 1]
	...
	pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0x1db2ef0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x1da2350; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x1da27c0; // [100 ] [1 / 1]
	pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x1da4980; // [100 ] [1 / 1]
	pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x1d9a420; // [100 ] [1 / 1]
	pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0x1d11530; // [100 ] [1 / 1]
	pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x1d26f20; // [100 ] [1 / 1]
	pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0x1d16600; // [100 ] [1 / 1]
	pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0x1d168c0; // [100 ] [1 / 1]
	pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0x1d15d10; // [100 ] [1 / 1]
	pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0x1d15f40; // [100 ] [1 / 1]
	pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0x1d15fa0; // [100 ] [1 / 1]
	pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0x1d161a0; // [100 ] [1 / 1]
	pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x1d1d650; // [100 ] [1 / 1]
	pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0x1d17630; // [100 ] [1 / 1]
	pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0x1d17660; // [100 ] [1 / 1]
	pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + 0x1d1d050; // [100 ] [1 / 1]
	pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0x1d15610; // [100 ] [1 / 1]
	pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x1d1e660; // [100 ] [1 / 1]
	pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x1d1d3c0; // [100 ] [1 / 1]
	pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x1d1d930; // [100 ] [1 / 1]
	pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x1d1d740; // [100 ] [1 / 1]
	pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x1dff5b0; // [100 ] [1 / 1]
	pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x1df1ae0; // [100 ] [1 / 1]
	pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x1e0da20; // [100 ] [1 / 1]
	pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x1e9b810; // [100 ] [1 / 1]
	pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x1d7db90; // [100 ] [1 / 1]
	pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x1dfc520; // [100 ] [1 / 1]

	pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x1ce2c60; // [100 %] [1 / 1]
	pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x1ce3940; // [100 %] [1 / 1]
#endif
#ifdef  VIDGAR
...
#ifdef PYTHON_CUSTOM
#ifdef ATYVA
	Globals::PyRun_SimpleStringFlags = (tPyRun_SimpleStringFlags)(Globals::hEntryBaseAddress + 0x1EFF790);
	Globals::PyString_AsString = (tPyString_AsString)(Globals::hEntryBaseAddress + 0x1ECAED0);
	Globals::PyTuple_GetItem = (tPyTuple_GetItem)(Globals::hEntryBaseAddress + 0x1EE7C20);
	Globals::PyInt_AsLong = (tPyInt_AsLong)(Globals::hEntryBaseAddress + 0x1EEF530);
#else
