...
public:
	...
	void OnTab1()
	{
		...
		ImGui::Separator();
		vector<string> configs2 = FileExtension::GetDirectoryFiles(FileExtension::GetAppDataDirectory() + "\\EngineX\\", "ic"   /*format "exe"*/);
		ImGui::PushItemWidth(200);
		...
		{
			Settings::SaveItemFilter(newFileName2, FileExtension::GetAppDataDirectory() + "\\EngineX\\");
		}
		ImGui::SameLine();
		if (ImGui::Button("Remove Item List"))
		{
			Settings::Remove(newFileName2, FileExtension::GetAppDataDirectory() + "\\EngineX\\", "ic");
		}
		ImGui::Separator();
		vector<string> configs3 = FileExtension::GetDirectoryFiles(FileExtension::GetAppDataDirectory() + "\\EngineX\\", "fc"   /*format "exe"*/);
		ImGui::PushItemWidth(200);
		...
		{
			Settings::SaveFarm(newFileName3, FileExtension::GetAppDataDirectory() + "\\EngineX\\");
		}
		ImGui::SameLine();
		if (ImGui::Button("Remove Paths"))
		{
			Settings::Remove(newFileName3, FileExtension::GetAppDataDirectory() + "\\EngineX\\", "fc");
		}
		ImGui::EndChild();
		ImGui::PopStyleVar();
	}
