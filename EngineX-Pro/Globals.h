...
void Globals::ReAddressingInstances()
{
	switch (Globals::Server)
	{
		case ServerName::METINPL:
			{
				...
				pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x20266a0; // [100 ] [1 / 1]
				pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x2023224; // [100 ] [1 / 1]
				pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x2023220; // [100 ] [1 / 1]
				pCItemManagerInstance = Globals::hEntryBaseAddress + 0x202321c; // [100 ] [1 / 1]
				pCPythonItemInstance = Globals::hEntryBaseAddress + 0x202677c; // [100 ] [1 / 1]
				pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x20289fc; // [100 ] [1 / 1]
				pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x202322c; // [100 ] [1 / 1]
				pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x2023218; // [100 ] [1 / 1]
				pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x2026738; // [100 ] [1 / 1]
				pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x202FA58;
				break;
			}
		...
		case ServerName::ASENIS:
			{
				pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x37b3e10; // [100 ] [103 / 103]
				pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x37b3e3c; // [98 ] [76 / 77]
				pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x37b3e20; // [95 ] [40 / 42]
				pCItemManagerInstance = Globals::hEntryBaseAddress + 0x381f058; // [100 ] [41 / 41]
				pCPythonItemInstance = Globals::hEntryBaseAddress + 0x381f07c; // [100 ] [5 / 5]
				pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x37BB530; 
				pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x381f048; // [100 ] [7 / 7]
				pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x381f050; // [100 ] [103 / 103]
				pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x37b3e30; // [100 ] [5 / 5]
				pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x36F2D8C; 
				break;
			}
		...
		{
			pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x14CC124; // [100 ] [110 / 110]
			pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x14CC158; // [98 ] [80 / 81]
			pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x14CC138; // [95 ] [41 / 43]
			pCItemManagerInstance = Globals::hEntryBaseAddress + 0x14CC190; // [100 ] [52 / 52]
			pCPythonItemInstance = Globals::hEntryBaseAddress + 0x14CE748; // [100 ] [4 / 4]
			pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x14CE794; // [100 ] [1 / 1]
			pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x14CC180; // [100 ] [3 / 3]
			pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x14CC188; // [99 ] [107 / 108]
			pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x14CC140; // [100 ] [6 / 6]
			pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x14D2CF4;
			break;
		}
	}
}
...
void Globals::ReAddressingLocas()
{
	switch (Globals::Server)
	{
		case ServerName::METINPL:
			{
				...
				pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x3a3350; // [100 ] [1 / 1]
				...
				pCItemDataGetName = Globals::hEntryBaseAddress + 0x3a5cc0; // [100 ] [1 / 1]
				pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x3a8450; // [100 ] [1 / 1]
				pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x76de0; // [100 ] [1 / 1]
				pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x42e330; // [100 ] [1 / 1]
				pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x1eaa10; // [100 ] [1 / 1]
				pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x1e8a70; // [100 ] [1 / 1]
				pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x42e1a0; // [100 ] [1 / 1]
				pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x42e150; // [100 ] [1 / 1]
				pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x42e7e0; // [100 ] [1 / 1]
				pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x42e810; // [100 ] [1 / 1]
				pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + 0x42e880; // [100 ] [1 / 1]
				pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x3cbe60; // [100 ] [1 / 1]
				pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x1c5110; // [100 ] [1 / 1]
				pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x1c45a0; // [100 ] [1 / 1]
				pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x841f0; // [100 ] [1 / 1]
				pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x14e580; // [100 ] [1 / 1]
				pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x9b010; // [100 ] [1 / 1]
				pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x1e8b50; // [100 ] [1 / 1]
				pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x1ea960; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x2004a0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x1fffd0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x1f9fd0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0x1fa1d0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0x20f8d0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x1fefc0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x1fef00; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x1fed90; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x204E40;
				pCPythonNetworkStreamSendFishingQuitPacket = Globals::hEntryBaseAddress + 0x204F30;
				pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0x204fb0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0x220700; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x220930; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x220bc0; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x220490; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x1fc380; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendRefinePacket = Globals::hEntryBaseAddress + 0x205B10;
				pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x1ff370; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x200420; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0x220290; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0x220210; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0x220370; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x200050; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x1fa160; // [100 ] [1 / 1]
				pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x1fbbb0; // [100 ] [1 / 1]
				pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x1ebd60; // [100 ] [1 / 1]
				pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0xe6d50; // [100 ] [1 / 1]
				pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x11fd10; // [100 ] [1 / 1]
				...
				pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x4314d0; // [100 ] [1 / 1]
				pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x41bfb0; // [100 ] [1 / 1]
				pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x4442e0; // [100 ] [1 / 1]
				pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x467fc0; // [100 ] [1 / 1]
				pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x412a30; // [100 ] [1 / 1]
				pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x42f060; // [100 ] [1 / 1]
				...
				pCPythonNetworkStreamSendCommandPacket = Globals::hEntryBaseAddress + 0x210990; // [100 ] [1 / 1]
				break;
			}
		case ServerName::ORIGINS2:
		{
		...
		{
			pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x2856f0; // [100 ] [1 / 1]
			pCPythonBackgroundGlobalPositionToMapInfo = Globals::hEntryBaseAddress + 0x177110; // [100 ] [1 / 1]
			pCInstanceBaseAvoidObject = Globals::hEntryBaseAddress + 0x285300; // [100 ] [1 / 1]
			pCInstanceBaseBlockMovement = Globals::hEntryBaseAddress + 0x158af0; // [100 ] [1 / 1]
			pCInstanceBaseGetInstanceType = Globals::hEntryBaseAddress + 0x159b70; // [100 ] [1 / 1]
			pCInstanceBaseGetInstanceVirtualNumber = Globals::hEntryBaseAddress + 0x159d30; // [100 ] [1 / 1]
			pCInstanceBaseGetNameString = Globals::hEntryBaseAddress + 0x159ca0; // [100 ] [1 / 1]
			pCInstanceBaseGetRotation = Globals::hEntryBaseAddress + 0x164600; // [100 ] [1 / 1]
			pCInstanceBaseIsDead = Globals::hEntryBaseAddress + 0x15a210; // [100 ] [1 / 1]
			pCInstanceBaseIsMountingHorse = Globals::hEntryBaseAddress + 0x15a3f0; // [100 ] [1 / 1]
			pCInstanceBaseNEW_GetPixelPosition = Globals::hEntryBaseAddress + 0x164610; // [100 ] [1 / 1]
			pCInstanceBaseNEW_MoveToDestPixelPositionDirection = Globals::hEntryBaseAddress + 0x163fa0; // [100 ] [1 / 1]
			pCInstanceBaseSCRIPT_SetPixelPosition = Globals::hEntryBaseAddress + 0x1646c0; // [100 ] [1 / 1]
			pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x1619c0; // [100 ] [1 / 1]
			pCInstanceBase__GetBackgroundHeight = Globals::hEntryBaseAddress + 0x15ce00; // [100 ] [1 / 1]
			pCItemDataGetName = Globals::hEntryBaseAddress + 0x27aa90; // [100 ] [1 / 1]
			pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x288990; // [100 ] [1 / 1]
			pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x177260; // [100 ] [1 / 1]
			pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x211fe0; // [100 ] [1 / 1]
			pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x1a4430; // [100 ] [1 / 1]
			pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x1a3ba0; // [100 ] [1 / 1]
			pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x2121b0; // [100 ] [1 / 1]
			pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x212220; // [100 ] [1 / 1]
			pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x212430; // [100 ] [1 / 1]
			pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x212470; // [100 ] [1 / 1]
			pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + 0x2124f0; // [100 ] [1 / 1]
			pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x2a0580; // [100 ] [1 / 1]
			pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x16ed10; // [100 ] [1 / 1]
			pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x16f460; // [100 ] [1 / 1]
			pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x17b9c0; // [100 ] [1 / 1]
			pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x182a10; // [100 ] [1 / 1]
			pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x18b5f0; // [100 ] [1 / 1]
			pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x1a3990; // [100 ] [1 / 1]
			pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x1a3ca0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x1b08d0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x1b09e0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x1b0b50; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0x1b0cc0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0x1a3f50; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x1b1190; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x1b12c0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x1b1340; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x1b13d0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0x1b14c0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0x1b4ba0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x1b4c10; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x1b4d50; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x1b4db0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x1b1df0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendRefinePacket = Globals::hEntryBaseAddress + 0x1b21f0; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x1b2230; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x1b2310; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0x1b5200; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0x1b5280; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0x1b5350; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x1b2360; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x1b2460; // [100 ] [1 / 1]
			pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x1b24d0; // [100 ] [1 / 1]
			pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x1a47b0; // [100 ] [1 / 1]
			pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0x1b8b40; // [100 ] [1 / 1]
			pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x1caf80; // [100 ] [1 / 1]
			pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0x1C0890;
			pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0x1c08f0; // [100 ] [1 / 1]
			pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0x1c0ae0; // [100 ] [1 / 1]
			pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0x1c0af0; // [100 ] [1 / 1]
			pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0x1c0bb0; // [100 ] [1 / 1]
			pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0x1c0d70; // [100 ] [1 / 1]
			pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x1c4c20; // [100 ] [1 / 1]
			pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0x1c1240; // [100 ] [1 / 1]
			pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0x1c1270; // [100 ] [1 / 1]
			pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0x1c1630; // [100 ] [1 / 1]
			pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x1c55b0; // [100 ] [1 / 1]
			pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x1c47d0; // [100 ] [1 / 1]
			pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x24add0; // [100 ] [1 / 1]
			pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x1c4df0; // [100 ] [1 / 1]
			pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x2397e0; // [100 ] [1 / 1]
			pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x21af30; // [100 ] [1 / 1]
			pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x21d660; // [100 ] [1 / 1]
			pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x2d7f80; // [100 ] [1 / 1]
			pCPythonApplicationOnUIRender = Globals::hEntryBaseAddress + 0x171d60; // [100 ] [1 / 1]
			pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x230190; // [100 ] [1 / 1]
			pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x163ce0; // [100 ] [1 / 1]
			pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x164760; // [100 ] [1 / 1]
			break;
		}
	}
